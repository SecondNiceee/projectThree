    ...
    return (
        <div className="container">
            <div className="section">
                ...
                <a href="https://github.com/SecondNiceee/projectThree" rel = "noopener noreferrer" target="_blank" className="border-blue-500 bg-blue-500 p-2 md:p-4 border-2 rounded-lg">
